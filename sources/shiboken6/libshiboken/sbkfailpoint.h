...
/// Disarm \a name if it is the armed throwing point; returns whether it
/// was. Unlike clearFailpoints(), this leaves a parking point alone.
LIBSHIBOKEN_API bool disarmFailpointThrow(const char *name);
...
inline bool disarmFailpointThrow(const char *) { return false; }
