...
out of the box by :ref:`Qt-WebEngine` . In addition it can work
on all browsers that support :mod:`PySide6.QtWebSockets` , enabling Qt
...
JavaScript library to access the serialized :class:`~PySide6.QtCore.QObject`
instances published by the host applications.
...
.. _`JavaScript API`: https://doc.qt.io/qt-6/qtwebchannel-javascript.html
