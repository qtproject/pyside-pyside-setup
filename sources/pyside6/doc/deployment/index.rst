...
:ref:`pyside6-android-deploy` and for iOS deployment, see :ref:`pyside6-ios-deploy`. Additionally,
you can also use other popular deployment tools shown below:
...
.. toctree::
    ...
    deployment-pyside6-ios-deploy.rst
    deployment-fbs.rst
